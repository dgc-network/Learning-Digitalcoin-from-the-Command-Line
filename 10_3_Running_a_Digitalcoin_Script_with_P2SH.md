...
## Summary: Building a Digitalcoin Script with P2SH

Once you know the technique of building P2SHes, any Script can be embedded in a Digitalcoin transaction; and once you understand the technique of validating P2SHes, it's easy to run the scripts in two rounds.

## What's Next?

Continue "Embedding Digitalcoin Scripts" with [§10.4: Scripting a Multisig](10_4_Scripting_a_Multisig.md).
