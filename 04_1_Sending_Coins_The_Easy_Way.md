...
```
You can see not only the amount transferred (.001 DGC) but also a transaction fee (.000222 DGC), which is about a quarter of the .001 DGC/kB minimum fee that was set, which suggests that the transaction was about a quarter of a kB in size.
